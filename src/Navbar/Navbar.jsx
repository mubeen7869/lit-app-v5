...
const Navbar = () => {
  ...
  return (
    <div className='main'>
      <div className='div1'><img src="https://littuss.com/wp-content/uploads/2022/09/LIT-TRULY-LOGO.png" alt="logo" className="img" /></div>
      <div className='main1'>
          ...
          <nav className="navbar">
            <li className="nav-list">
              <li className="nav-item">HR Lap <FontAwesomeIcon icon={faCaretDown} className='fontsize' />
                <li className="dropdown">
                  ...
                  <li className="sub-item-3">Internship Lap <FontAwesomeIcon icon={faCaretDown} className='fontsize' />
                    ...
                    <li className="sub-item1"><Link to={"/home/internRegistation"}>Registration</Link></li>
                      <li className="sub-item2"><Link to={"/home/internSearch"}> Search</Link></li>
                      <li className="sub-item3"><Link to={"/home/internManagement"}>Management</Link></li>
                    </li>
                  </li>
                </li>
              </li>
              <li className="nav-item">Employee Lap <FontAwesomeIcon icon={faCaretDown} className='fontsize' />
                <li className="dropdown">
                <li className="sub-item1"><Link to={"/home/employeeRegistation"}> Registration</Link></li>
                      <li className="sub-item2"><Link to={"/home/employeeSearch"}>Search</Link></li>
                      <li className="sub-item3"><Link to={"/home/employeeManagement"}> Management</Link></li>
                </li>
              </li>
              <li className="nav-item">Finance Lap <FontAwesomeIcon icon={faCaretDown} className='fontsize' />
                <li className="dropdown">
                <li className="sub-item11"><Link to={"/home/financeRegistration"}> Registration</Link></li>
                      <li className="sub-item22"><Link to={"/home/financeSearch"}>Search</Link></li>
                      <li className="sub-item33"><Link to={"/home/financeMangement"}>Management</Link></li>
                </li>
              </li>
              ...
              <li className="nav-item1">Asset lap <FontAwesomeIcon icon={faCaretDown} className='fontsize' />
                <li className="dropdown2">
                  <li className="sub-item-4">Registration <FontAwesomeIcon icon={faCaretDown} className='fontsize' />
                  ...
                  <li className="sub-item-5">Search <FontAwesomeIcon icon={faCaretDown} className='fontsize' />

                    <li className="nested-dropdown5">
                    <li className="sub-item4"><Link to={"/home/assetsSearch1stFloor"}>1st Floor Asset</Link></li>
                      <li className="sub-item5"><Link to={"/home/assetsSearch2stFloor"}>2nd Floor Asset</Link></li>
                      
                    </li>
                  </li>


                  <li className="sub-item-6">Management <FontAwesomeIcon icon={faCaretDown} className='fontsize' />
                    <li className="nested-dropdown6">
                    <li className="sub-item4"><Link to={"/home/assetsManagement1stFloor"}>1st Floor Asset</Link></li>
                      <li className="sub-item5"><Link to={"/home/assetsManagement2stFloor"}>2nd Floor Asset</Link></li>
              ...
              <li className="nav-item" >Requirement <FontAwesomeIcon icon={faCaretDown} className='fontsize' />
                ...
                <li className="sub-item30"><Link to={"/home/addRequirement"}>Add Requirement</Link></li>
                      ...
                      <li className="sub-item32"><Link to={"/home/requirementManagement"}> Management</Link></li>
                </li>
              </li>
